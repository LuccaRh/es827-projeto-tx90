...
O código completo utilizado para gerar a trajetória, calcular a cinemática inversa, avaliar a dinâmica e simular os controladores é apresentado a seguir.

\begingroup
\singlespacing
\lstinputlisting[caption={Código completo da simulação do Stäubli TX90.},label={lst:codigo_tx90}]{../simulacao/tx90_simulacao.m}
\endgroup
